      ...
      <ul class="Answer_con">
        <li v-for="responseItem in responseList" @click="goAnsweringDetails(responseItem.doctorId,responseItem.answerId)">
          ...
          <div class="Answer_btn">
            <a  class="f_r f_r_icon">收藏 {{responseItem.bookmarkCount }}</a>
            <a  class="f_r f_r_icon">评论 {{responseItem.commentCount}}</a>
            <a  class="f_r f_r_icon">有用 {{responseItem.helpfulCount}}</a>
